...
const OBJECT_PERMISSION_COLUMNS = [
  ...
  { label: "Assigned Users", fieldName: "assignedUserCount", type: "number", cellAttributes: { alignment: "left" } },
  { label: "View All", fieldName: "permissionViewAllRecords", type: "boolean" },
  { label: "\"View All\" Violation", fieldName: "permissionViewAllRecordsViolation", type: "boolean" },
  { label: "Modify All", fieldName: "permissionModifyAllRecords", type: "boolean" },
  { label: "\"Modify All\" Violation", fieldName: "permissionModifyAllRecordsViolation", type: "boolean" },
  {
...
export default class ObjectPermissionViewer extends LightningElement {
  ...
  @wire(getObjectPermissions, { onlyCustomPermissionSets: "$onlyCustomPermissionSets" })
  ...
  handleRowAction(event) {
    ...
    switch (action.name) {
      case "show_details":
        let assignedUserProfiles = this.objectPermissions.filter(op => op.uniqueKey === row.uniqueKey)[0].assignedUserProfiles;
